// @pb-anchor source=d_tag.srd kind=datawindow-page-codebehind
using Microsoft.AspNetCore.Components;

namespace ProductCatalog.Blazor.Components.Pages.Tag;

/// <summary>
/// Auto-generated routable page wrapper for the d_tag DataWindow. The actual
/// data binding + grid/form rendering lives in the Tag component under
/// Components/DataWindows/. This page just hosts that component at /tag.
/// Add per-page logic (filters, breadcrumbs, query-string handling) here.
///
/// Class is named `TagPage` (not `Tag`) so Razor's tag-helper
