// @pb-anchor source=d_tag.srd kind=datawindow-codebehind
...
{
    [Inject] private TagService _svc { get; set; } = default!;
    [Inject] private ISnackbar Snackbar { get; set; } = default!;

    internal IReadOnlyList<TagDto> _rows = Array.Empty<TagDto>();
    internal TagDto? _row;
