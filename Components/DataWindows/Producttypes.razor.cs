// @pb-anchor source=d_producttypes.srd kind=datawindow-codebehind
...
public partial class Producttypes : ComponentBase
{
    [Inject] private ProducttypesService _svc { get; set; } = default!;
    [Inject] private ISnackbar Snackbar { get; set; } = default!;

    internal IReadOnlyList<ProducttypesDto> _rows = Array.Empty<ProducttypesDto>();
    internal ProducttypesDto? _row;
