// @pb-anchor source=d_productbrands.srd kind=datawindow-codebehind
...
public partial class Productbrands : ComponentBase
{
    [Inject] private ProductbrandsService _svc { get; set; } = default!;
    [Inject] private ISnackbar Snackbar { get; set; } = default!;

    internal IReadOnlyList<ProductbrandsDto> _rows = Array.Empty<ProductbrandsDto>();
    internal ProductbrandsDto? _row;
